...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, Les1Component, Les3Component, Les4Component, Les5Component, Les6Component, Les7Component, Les8Component, Les9parentComponent, Les10parentComponent],
